...
#TODO change the max size, to something smaller
...
#Take the output and avoid it to repeat the same sentence over and over
...
def evaluateInput(encoder, decoder, searcher, voc, utterance):
    try:
        # Normalize sentence
        utterance = normalizeString(utterance)
        # Evaluate sentence
        output_words = evaluate(encoder, decoder, searcher, voc, utterance)
        # Format and print response sentence
        output_words[:] = [x for x in output_words if not (x == 'EOS' or x == 'PAD')]
        return reduce(output_words)

    except KeyError:
        return "Sorry I don't understand your sentence. Try to say it in another way."
